...
""",
    ...
    'images': [
        ...
        'static/description/screenshots/02_internal_transfers.png',
        'static/description/screenshots/03_profit_loss.png',
        'static/description/screenshots/04_balance_sheet.png',
        'static/description/screenshots/05_executive_summary.png',
        'static/description/screenshots/06_period_closing.png',
        'static/description/screenshots/07_recurring_payments.png',
    ],
    'depends': [
        'account',
        'analytic',
